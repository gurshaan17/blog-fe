...
import { getApprovedBlogs } from '../utils/auth';
...
const Public = () => {
    ...
    return (
        <div className="container mx-auto mt-10">
            <h2 className="text-2xl font-semibold mb-4 text-center">Public Blogs</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {blogs.map((blog) => (
                    <div key={blog._id} className="bg-white p-6 shadow-lg rounded-lg">
                        ...
                        <p className="text-gray-500 text-sm">By: {blog.author.email}</p>
